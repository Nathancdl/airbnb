...
class ReservationRepository extends ServiceEntityRepository
{
    ...
    public function findAvailableLogements(\DateTime $dateDebut, \DateTime $dateFin)
    {
        return $this->createQueryBuilder('r')
            ->select('l')
            ->leftJoin('r.logement', 'l')
            ->where('r.dateDebut > :dateFin OR r.dateFin < :dateDebut')
    ...
    public function checkDisponibilite(int $logementId, \DateTime $dateDebut, \DateTime $dateFin): bool
    {
